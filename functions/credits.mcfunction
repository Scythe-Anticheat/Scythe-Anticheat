...
tellraw @s {"rawtext":[{"text":"§lGithub: https://github.com/MrDiamond64/Scythe-AntiCheat"}]}
...
tellraw @s {"rawtext":[{"text":"And lastly, Mojang for horribly securing their Dedicated Server Software to the point where the community patches exploits themselves."}]}
