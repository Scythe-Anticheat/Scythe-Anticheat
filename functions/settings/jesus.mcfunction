...
execute @s[type=player,tag=op,scores={jesus=..0}] ~~~ tellraw @a[tag=op] {"rawtext":[{"text":"§r§6[§aScythe§6]§r "},{"selector":"@s"},{"text":" has disabled §4Anti-jesus!"}]}

# allow
execute @s[type=player,tag=op,scores={jesus=1..}] ~~~ scoreboard players set scythe:config jesus 0
execute @s[type=player,tag=op,scores={jesus=1..}] ~~~ tellraw @a[tag=op] {"rawtext":[{"text":"§r§6[§aScythe§6]§r "},{"selector":"@s"},{"text":" has enabled §aAnti-jesus!"}]}
