...
execute @a[tag=!bypass,scores={leftclick=15..,leftclick_timer=70..}] ~~~ tellraw @a[tag=notify] {"rawtext":[{"text":"§r§6[§aScythe§6]§r "},{"selector":"@s"},{"text":" §1has failed §7(Misc) §4AutoClicker/A (CPS: "},{"score":{"name":"@s","objective":"leftclick"}},{"text":") VL= "},{"score":{"name":"@s","objective":"leftclickvl"}}]}
