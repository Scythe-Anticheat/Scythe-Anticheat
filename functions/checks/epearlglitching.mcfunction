...
execute @e[type=ender_pearl,tag=enderPearlGlitch] ~~~ execute @p ~~~ tellraw @a[tag=notify] {"rawtext":[{"text":"§r§6[§aScythe§6]§r "},{"selector":"@s"},{"text":" §1has failed §7(Misc) §4Ender Pearl Glitching/A. VL= "},{"score":{"name":"@s","objective":"epearlGlitch"}}]}
