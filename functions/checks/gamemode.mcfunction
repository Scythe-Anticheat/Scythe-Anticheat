...
gamemode 2 @s[tag=!op,m=a,scores={gma=1..,gma=1..}]
gamemode 1 @s[tag=!op,m=a,scores={gma=1..,gmc=1..}]
...
gamemode 2 @s[tag=!op,m=c,scores={gmc=1..,gma=1..}]
gamemode 0 @s[tag=!op,m=c,scores={gmc=1..,gms=1..}]
...
gamemode 2 @s[tag=!op,m=s,scores={gms=1..,gma=1..}]
gamemode 1 @s[tag=!op,m=s,scores={gms=1..,gmc=1..}]
