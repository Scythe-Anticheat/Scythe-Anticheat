...
gamemode 2 @s[tag=!op,m=a,scores={gmc=..0}]
gamemode 1 @s[tag=!op,m=a,scores={gms=..0}]
...
gamemode 2 @s[tag=!op,m=c,scores={gma=..0}]
gamemode 0 @s[tag=!op,m=c,scores={gms=..0}]
...
gamemode 2 @s[tag=!op,m=s,scores={gma=..0}]
gamemode 1 @s[tag=!op,m=s,scores={gmc=..0}]
