...
tag @r[tag=!bypass,tag=!flying,m=!c,tag=!speedtest,tag=!speedtest2,tag=!gliding] add speedtest
...
execute @e[type=scythe:speedtest] ~~~ execute @a[m=!c,tag=speedtest2,tag=!NoSpeed,tag=!riding,tag=!gliding] ~~~ scoreboard players add @s speedvl 1
execute @e[type=scythe:speedtest] ~~~ execute @a[m=!c,tag=speedtest2,tag=!NoSpeed,tag=!riding,tag=!gliding] ~~~ tellraw @a[tag=notify] {"rawtext":[{"text":"§r§6[§aScythe§6]§r "},{"selector":"@s"},{"text":" §1has failed §4Speed/FastWalk. VL= "},{"score":{"name":"@s","objective":"speedvl"}}]}
execute @e[type=scythe:speedtest] ~~~ execute @a[m=!c,tag=speedtest2,tag=!NoSpeed,tag=!riding,tag=!gliding] ~~~ tp @s @e[type=scythe:speedtest] true
